...
prompt_tc = ChatPromptTemplate.from_messages([
    ("system", "You are a QA engineer. Write all the possible clear manual test case including postitve, negative and edge case scenarios. write better title"),
...
def create_test_case_agent(state:QAState):
